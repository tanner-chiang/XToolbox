...
redistname = 'Basic Redists 1.0 SFX.exe'
...
print(Fore.WHITE +"[K>] Do you wanna install Redists?")
...
if libreinstall == 'y':
    ...
    print(Fore.RED +"[S>] All done, exiting...")
    time.sleep(2)
    exit()