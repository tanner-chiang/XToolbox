/*
http://www.emptyloop.com/unlocker/Unlocker1.9.2.exe
*/
!define DLVER	"1.9.2_32-64"
!define APPVER 	"0.0.0.0"
!define APPNAME "Unlocker"
!define APP 	"Unlocker"
!define DLNAME	"Unlocker"
!define APPLANG	"Multilingual"
!define FOLDER	"UnlockerPortable"
!define FINISHRUN ; Delete if not Finish pages
!define SOURCES ; Delete if no Sources
; !define DESCRIPTION	"Unlock files and folders with right click" ; Delete if no AppInfo
